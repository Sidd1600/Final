...
export default function App() {
    ...
    routes = (
      <>
        ...
        <Route
          exact
          path="/user/about"
          element={<AboutPage setNavbar={userNavbar} />}
        />
        <Route
          exact
          path="/user/faq"
          element={<FAQPage setNavbar={userNavbar} />}
        />
        <Route
          exact
          path="/user/home"
          element={<Home setNavbar={userNavbar} />}
        />
        <Route
          exact
          path="/user/menu"
        ...
        <Route
          exact
          path="/admin/order"
          element={<AdminOrders order={order} setNavbar={adminNavbar} />}
        />
        <Route
          exact
          path="/admin/menu"
          element={<AdminMenu setNavbar={adminNavbar} />}
        />
      </>
    );
  } else {
  ...
  return (
    ...
    >
      <BrowserRouter>
        <Background />
        {chooseNavbar === 0 ? null : chooseNavbar === 1 ? (
